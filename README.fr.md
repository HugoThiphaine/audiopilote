...
Lire en : [English](README.md) | Français
...
- Slider de volume (volume de sortie, gain d'entrée)
- VU-mètre d'entrée en temps réel, déclenché par entrée via un bouton
...
écoute les branchements et débranchements. L'ordre de priorité est mémorisé par
